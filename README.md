...
/ 2 pts
  ...
  - [Evidence of sprint burndown update July 7th.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/sprint%20burndown%20july%207.png)
  - [Evidence of sprint task board update July 7th.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/sprint%20board%20july%207.png)
...
/ 1 pts
  - Our team conducted our Sprint Review on the morning of July 8th.
...
/ 4 pts
  - Our team conducted our Sprint Retrospective on the morning of July 8th. [Miro board.](https://miro.com/app/board/uXjVK1Rl7ig=/)
  - All members participated in the retrospective. [Photo.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/retro%20july%208.jpg)
  - We've identified at least one helpful change to improve our effectiveness. (Improve PO skills)
  - We made a concrete plan for making that change during the next sprint. (Add PBI for improving PO skills and adding to our backlog)
- All of the PBIs in your product backlog are true user stories.
/ 5 pts
...
- Every day during the sprint, update your sprint task board and burndown chart. Provide evidence (URLs or images) in your README to show that you did this. (1 point for each time you updated your tracking indicators, up to a maximum of 2 points)
/ 2 pts
  - [Evidence of sprint burndown update July 9th.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/sprint%20burndown%20july%209.png)
  - [Evidence of sprint task board update July 9th.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/kanban%20board%20july%209.png)
  - [Evidence of sprint burndown update July 10th.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/sprint%20burndown%20july%2010.png)
  - [Evidence of sprint task board update July 10th.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/meta_assets/kanban%20board%20july%2010.png)
- Pair- or Mob-Programming: There is evidence that you paired or mobbed on your code. The evidence could be a photo or video of your team working together, or it could be some other kind of evidence. The evidence is included in your README. (1 point for each team member who participated, up to a maximum of 5 points)
/ 5 pts
...
/ 11 pts
  - BDD test.
    - [Here is where the BDD suite triggers.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/commushare_front/test_driver/app_test.dart)
    - [Here is the features file.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/commushare_front/test_driver/features/search_by_owner.feature)
    - [Here is the steps definition.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/blob/main/commushare_front/test_driver/steps/search_by_owner_step.dart)
  - Micro-scale unit tests.
    ...
    - [Here are they running in CI/CD.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/actions/runs/9877610677/job/27279639185#step:4:101)
- Continuous Integration: You have a Continuous Integration system running. You only work on the main/trunk/master together—there are no long-lived code branches. The CI system automatically builds your code every time you push to main/trunk/master. The CI system automatically executes all your tests every time it builds the code. You have provided evidence that your CI system exists and behaves properly. (1 point for each sentence in this rubric element)
/ 5 pts
  - We have the CI system in-place. [Github Actions link.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/actions)
  - We only work on main, see our [commit history.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/commits/main/) And there are no other active branches, see [our branches.](https://github.com/CrimsonDreamers/CSCI-S-71-Project---CommuShare/branches)
